(function (global, factory) {
	...
	(global.reactHocPromises = factory(global.React));
  ...
  return function (WrappedComponent) {
    var WithPromises = function (_React$Component) {
      ...
      function WithPromises(props) {
        ...
        var _this = possibleConstructorReturn(this, (WithPromises.__proto__ || Object.getPrototypeOf(WithPromises)).call(this, props));
      ...
      createClass(WithPromises, [{
        ...
        value: function componentDidMount() {
          ...
          return Promise.all(Object.values(mapPromisesToProps)).then(function (datas) {
            var state = Object.keys(mapPromisesToProps).reduce(function (acc, key, index) {
